package com.wqf.imports.sys.service.impl;

import com.wqf.imports.common.exception.RRException;
import com.wqf.imports.common.utils.DateUtils;
import com.wqf.imports.sys.dao.SysDictDao;
import com.wqf.imports.sys.dao.SysNumberRuleDao;
import com.wqf.imports.sys.entity.SysDictEntity;
import com.wqf.imports.sys.entity.SysNumberRuleEntity;
import com.wqf.imports.sys.service.SysNumberRuleService;
...
public class SysNumberRuleServiceImpl implements SysNumberRuleService {
	 ...
	 */
	@Override
	public String getCodeNumber(String prefix){
        ...
        if(sysNumberRule!=null){
            ...
            //获得年月日
            //获得随机数
			if(sysNumberRule.getTimeType() == null){
				codeNumber=sysNumberRule.getPrefix()+getFixLenthString(sysNumberRule);
			}else{
	...
	@Override
	public String getCodeNumber(String type,String code){
